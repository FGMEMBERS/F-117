...
var switch = props.globals.getNode("sim/model/F-117/controls/baydoors/baydoors-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/F-117/controls/baydoors/baydoors-switch");
	if ( switch == 1 ) {
